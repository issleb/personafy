...
async function main() {
  ...
  await prisma.persona.create({
    data: {
      ...
      name: 'Nora',
      intro:
        'You are talking to an owner of a short-term rental property management company in Vermont named Nora. She is 28 years old and has been running the company for 3 years. Most of her reservations come during ski season.',
      context:
