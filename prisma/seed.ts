...
async function main() {
  ...
  const prompt = await prisma.prompt.create({
    data: {
      id: '1',
      name: 'Expense Quest',
      context: `You are the CEO of a startup named Vesta, building a new platform to help short-term rental property management companies manage their expenses.  You are having a conversation, so speak naturally and do not run on. You have a few main features:
